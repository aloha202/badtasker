...
abstract class BaseTaskFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_failed'                     => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'punishment_comment'            => new sfWidgetFormFilterInput(),
      'is_deadline_changed'           => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'is_deadline_notification_sent' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'status'                        => new sfValidatorChoice(array('required' => false, 'choices' => array('in_progress' => 'in_progress', 'done' => 'done', 'failed' => 'failed', 'archived' => 'archived'))),
      'comment'                       => new sfValidatorPass(array('required' => false)),
      'is_failed'                     => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'punishment_comment'            => new sfValidatorPass(array('required' => false)),
      'is_deadline_changed'           => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'is_deadline_notification_sent' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
