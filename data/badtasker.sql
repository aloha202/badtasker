...
--
-- Host: localhost
-- Generation Time: Sep 18, 2019 at 05:02 PM
...
--
-- Table structure for table `board2_user`
--

CREATE TABLE `board2_user` (
  `board_id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `board2_user`
--

INSERT INTO `board2_user` (`board_id`, `user_id`) VALUES
(1, 1),
(2, 14),
(3, 1),
(3, 14),
...
(67, 1, 'aoix2q3ba48wo08s04gc44sokg44c8c', '127.0.0.1', '2019-09-18 17:42:12', '2019-09-18 17:42:12');
...
(1, 'Админ32', '', 'admin@admin.com', 'admin', 'sha1', '4b94b61d1e21fab73088930db9da4807', '14ebadf4cf6d65ba509fec1ee3d6a7e572c40098', 1, 1, '2019-09-18 17:42:12', 'en', '2014-11-08 23:12:31', '2019-09-18 17:42:12'),
(14, 'Alesia', '', 'alesiashavel1985@gmail.com', 'alesia', 'sha1', '99da675a071b5008882600b2e21f2bf2', '2e7b0265b32ad571074ea12049bbe18027902731', 1, 0, NULL, 'en', '2019-09-13 09:07:58', '2019-09-13 09:07:58');
...
CREATE TABLE `task` (
  `id` bigint(20) NOT NULL,
  `board_id` bigint(20) NOT NULL,
  `executer_id` bigint(20) NOT NULL,
...
(1795, 'Запомнить меня на этом компьютере', NULL, NULL, 'frontend', NULL, NULL, 0),
(1796, 'Введите код', NULL, NULL, 'frontend', NULL, NULL, 0),
(1797, 'Board', NULL, NULL, 'frontend', NULL, NULL, 0),
(1798, 'Executer', NULL, NULL, 'frontend', NULL, NULL, 0),
(1799, 'Responsible', NULL, NULL, 'frontend', NULL, NULL, 0),
(1800, 'Name', NULL, NULL, 'frontend', NULL, NULL, 0),
(1801, 'Description', NULL, NULL, 'frontend', NULL, NULL, 0),
(1802, 'Deadline', NULL, NULL, 'frontend', NULL, NULL, 0),
(1803, 'Punishment', NULL, NULL, 'frontend', NULL, NULL, 0),
(1804, 'in_progress', NULL, NULL, 'frontend', NULL, NULL, 0),
(1805, 'done', NULL, NULL, 'frontend', NULL, NULL, 0),
(1806, 'failed', NULL, NULL, 'frontend', NULL, NULL, 0),
(1807, 'Status', NULL, NULL, 'frontend', NULL, NULL, 0);
...
(1795, 'Запомнить меня на этом компьютере', 'en'),
(1796, 'Введите код', 'en'),
(1797, 'Board', 'en'),
(1798, 'Executer', 'en'),
(1799, 'Responsible', 'en'),
...
--
-- Indexes for table `board2_user`
--
ALTER TABLE `board2_user`
...
ALTER TABLE `task`
  ADD PRIMARY KEY (`id`),
  ADD KEY `board_id_idx` (`board_id`),
  ADD KEY `executer_id_idx` (`executer_id`),
  ADD KEY `responsible_id_idx` (`responsible_id`),
  ADD KEY `user_id_idx` (`user_id`);
